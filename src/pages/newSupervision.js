...
const NotificationList = () => {
    ...
    async function fetchNotifications() {
        try {
            ...
            const supervisionFilter = formattedNotifications.filter(data => data.information === "Supervisão")
                        ...
                        >
                            ...
                            <Modal.Body>
                                ...
                                <div style={{ fontSize: "20px" }}>
                                    ...
                                    <p>Ausentes:  {modalInfo.workerInformation && modalInfo.workerInformation.length}</p>
                                    <p>Lista dos trabalhadores ausentes:</p>
                                    <ul>
                                        {modalInfo && modalInfo.workerInformation && modalInfo.workerInformation.map((item, index) => (
                                            <li key={index}>
                                                <div>
                                                    <p>Nome: {item.name}</p>
                                    ...
                                    <hr />
                                    <h1 style={{ textAlign: 'center' }}>Informação dos equipamentos</h1>
                                    <p>Quantidade de equipamentos encontrado:  {modalInfo.equipment && modalInfo.equipment.length}</p>
                                    <p>Lista dos equipamentos encontrados: </p>
                                    <ul>
                                        {modalInfo && modalInfo.equipment && modalInfo.equipment.map((item, index) => (
                                            <li key={index}>
                                                <div>
                                                    <p>Nome: {item.name}</p>
                                    ...
                                    <hr />
                                    <h1 style={{ textAlign: 'center' }}>Informação extra da supervisão</h1>
